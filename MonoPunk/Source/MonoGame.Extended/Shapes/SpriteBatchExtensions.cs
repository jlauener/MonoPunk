...
namespace MonoGame.Extended.Shapes
{
    ...
    public static class SpriteBatchExtensions
    {
            ...
            Color color, float thickness)
        {
            ...
            spriteBatch.Draw(texture, point1, null, color, angle, Vector2.Zero, scale, SpriteEffects.None, 0.0f);
        }
            ...
            float thickness = 1f)
        {
            ...
            spriteBatch.Draw(texture, topLeft, null, color, 0.0f, Vector2.Zero, horizontalScale, SpriteEffects.None, 0.0f);
            spriteBatch.Draw(texture, topLeft, null, color, 0.0f, Vector2.Zero, verticalScale, SpriteEffects.None, 0.0f);
            spriteBatch.Draw(texture, topRight, null, color, 0.0f, Vector2.Zero, verticalScale, SpriteEffects.None, 0.0f);
            spriteBatch.Draw(texture, bottomLeft, null, color, 0.0f, Vector2.Zero, horizontalScale, SpriteEffects.None, 0.0f);
        }
        ...
        public static void DrawPoint(this SpriteBatch spriteBatch, Vector2 position, Color color, float size = 1f)
        {
            ...
            spriteBatch.Draw(GetTexture(spriteBatch), position + offset, null, color, 0.0f, Vector2.Zero, scale, SpriteEffects.None, 0.0f);
        }
